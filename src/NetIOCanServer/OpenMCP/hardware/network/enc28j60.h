...
// Link Flags
#define LINK_OK                         0                                   //
#define LINK_DOWN                       !LINK_OK                          

// buffer boundaries applied to internal 8K ram
// entire available packet buffer space is allocated
#define TXSTART_INIT   	0x1400	// start TX buffer at 0
#define RXSTART_INIT   	0x0000	// give TX buffer space for one full ethernet frame (~1500 bytes)
#define RXSTOP_INIT    	0x13FE	// receive buffer gets the rest
...
//#define RXSTART_INIT   	MAX_FRAMELEN+1	// give TX buffer space for one full ethernet frame (~1500 bytes)
	...
	#define	MAX_FRAMELEN	512	// maximum ethernet frame length
#endif
